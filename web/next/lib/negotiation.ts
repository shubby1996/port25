...
export type Negotiation = {
  ...
  commodity: string; quantity: number; price_unit: string; currency: string; buyer_region: string; supplier_region: string;
...
export type Health = {
  ...
  setup?: {
    ...
    commodities: { id: string; label: string; quantity: number; price_unit: string }[];
    regions: string[];
    defaults: StartOptions;
  };
};
export type StartOptions = {
  buyer_account: string; supplier_account: string; commodity: string;
  buyer_region: string; supplier_region: string;
};
...
export const startNegotiation = (options: StartOptions) => request<Negotiation>("/negotiation", { method: "POST", body: JSON.stringify(options) });
